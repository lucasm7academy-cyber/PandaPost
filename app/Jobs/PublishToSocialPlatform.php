...
class PublishToSocialPlatform implements ShouldQueue
{
    ...
    private function getPublisher(): XPublisher|TikTokPublisher|YouTubePublisher|FacebookPublisher|InstagramPublisher|ThreadsPublisher
    {
        return match ($this->postPlatform->platform) {
            ...
            SocialPlatform::YouTube, SocialPlatform::YouTubeLong => app(YouTubePublisher::class),

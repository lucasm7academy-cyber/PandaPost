...
class InstagramPublisher
{
    ...
    {
        $imageUrl = $this->cropForFeed($media->path, $media->url, $aspectRatio);
    ...
    private function publishCarousel(string $instagramId, string $accessToken, ?string $content, $mediaCollection, ?string $aspectRatio): array
    {
        ...
        foreach ($mediaCollection as $media) {
            ...
            if ($isVideo) {
                ...
                $params['image_url'] = $this->cropForFeed($media->path, $media->url, $aspectRatio);
            }
     ...
     */
    private function cropForFeed(string $imagePath, string $imageUrl, ?string $aspectRatio): string
    {
        ...
        try {
            copy(Storage::path($imagePath), $tempInput);

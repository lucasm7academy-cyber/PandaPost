...
return [
    ...
    'create' => [
        ...
        'bulk_title' => 'Bulk schedule',
        'bulk_description' => 'Pick media, platforms and a schedule — we line up the posts for you.',
        'bulk_upgrade_reason' => 'Bulk scheduling is available on Plus and above. Upgrade to unlock.',
        'bulk_pro_badge' => 'Plus',
    ...
    'bulk' => [
        'steps' => [
            'media_title' => 'Select your media',
            'media_description' => 'Each media you pick will become its own post.',
            'media_label' => ':count media selected',
            'media_pick' => 'Pick media',
            'media_empty' => 'No media yet. Pick from your gallery to get started.',
            'media_remove' => 'Remove media',

            'platforms_title' => 'Pick the platforms',
            'platforms_description' => 'Select the accounts that will publish every post.',
            'platforms_label' => 'Connected accounts',

            'schedule_title' => 'When to publish',
            'schedule_description' => 'Choose the days, then add as many times as you want.',
            'days_label' => 'Days to publish',
            'days_count' => ':count days selected',
            'times_label' => 'Times per day',
            'times_add' => 'Add time',
        ...
        'summary' => [
            'will_create' => 'Will create :count scheduled posts.',
            'breakdown' => ':media media × (:days days · :times times) = :slots slots.',
            'discarded' => ':count media will be discarded (no slot available).',
            'empty_slots' => ':count empty slots at the end (not enough media).',
        ],
        ...
        'loading' => [
            'page_title' => 'Scheduling your posts',
            'completed_title' => 'All posts scheduled!',
            'failed_title' => 'Something went wrong',
            'failed_body' => 'We could not finish scheduling. Please try again.',
            'progress' => ':created of :total posts created',
            'leave_title' => 'You can keep working.',
            'leave_body' => 'We will keep scheduling in the background.',
            'view_scheduled' => 'View scheduled posts',
            'view_calendar' => 'Open calendar',
        ],

        'errors' => [
            'missing_context' => 'Missing workspace or user context.',
            'start_failed' => 'Could not start bulk scheduling. Please try again.',
        ],

        'flash' => [
            'starter_blocked' => 'Bulk scheduling is available on Plus and above. Upgrade to unlock.',
        ],
    ],

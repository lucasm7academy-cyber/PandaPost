...
return [
    ...
    'add_social_description' => 'Conecta una cuenta social a PandaPost para empezar a publicar',
    ...
    'descriptions' => [
        ...
        'youtube' => 'Conecta un canal de YouTube para Shorts',
        'youtube-long' => 'Conecta un canal de YouTube para Videos',
    ...
    'youtube' => [
        'title' => 'Seleccionar canal de YouTube',
        'description' => 'Elige qué canal deseas conectar',
        'no_channels' => 'No se encontraron canales',
        'no_channels_description' => 'No tienes ningún canal de YouTube. Por favor, crea un canal primero.',
    ],

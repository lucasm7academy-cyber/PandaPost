...
return [
    ...
    'create' => [
        ...
        'bulk_title' => 'Programación masiva',
        'bulk_description' => 'Elige medios, plataformas y horarios — programamos todos los posts por ti.',
        'bulk_upgrade_reason' => 'La programación masiva está disponible en Plus o superior. Actualiza para desbloquear.',
        'bulk_pro_badge' => 'Plus',
    ...
    'bulk' => [
        'steps' => [
            'media_title' => 'Selecciona los medios',
            'media_description' => 'Cada medio se convierte en un post individual.',
            'media_label' => ':count medios seleccionados',
            'media_pick' => 'Elegir medios',
            'media_empty' => 'Aún no hay medios. Elige de tu galería para comenzar.',
            'media_remove' => 'Quitar medio',

            'platforms_title' => 'Elige las plataformas',
            'platforms_description' => 'Selecciona las cuentas que publicarán todos los posts.',
            'platforms_label' => 'Cuentas conectadas',

            'schedule_title' => 'Cuándo publicar',
            'schedule_description' => 'Elige los días y añade los horarios que quieras.',
            'days_label' => 'Días de la programación',
            'days_count' => ':count días seleccionados',
            'times_label' => 'Horarios por día',
            'times_add' => 'Añadir horario',
            'times_remove' => 'Quitar horario',

            'prompt_title' => 'Describe las leyendas',
            'prompt_description' => 'La IA usa este brief para escribir una leyenda única por post.',
            'prompt_label' => 'Brief',
            'prompt_placeholder' => 'Ej.: Destacar el lanzamiento de la nueva colección — tono confiable, en español.',
            'prompt_hint' => 'La IA generará una variación corta para cada post programado.',

            'confirm_title' => 'Listo para publicar',
            'confirm_description' => 'Revisa la programación y confirma para enviar todo a la cola.',
        ],

        'summary' => [
            'will_create' => 'Creará :count posts programados.',
            'breakdown' => ':media medios × (:days días · :times horarios) = :slots slots.',
            'discarded' => ':count medios serán descartados (sin slot disponible).',
            'empty_slots' => ':count slots vacíos al final (faltaron medios).',
        ],
        ...
        'loading' => [
            'page_title' => 'Programando tus posts',
            'completed_title' => '¡Todos los posts programados!',
            'failed_title' => 'Algo salió mal',
            'failed_body' => 'No pudimos terminar la programación. Inténtalo de nuevo.',
            'progress' => ':created de :total posts creados',
            'leave_title' => 'Puedes seguir trabajando.',
            'leave_body' => 'Seguiremos programando en segundo plano.',
            'view_scheduled' => 'Ver posts programados',
            'view_calendar' => 'Abrir calendario',
        ],

        'errors' => [
            'missing_context' => 'Workspace o usuario no encontrados.',
            'start_failed' => 'No se pudo iniciar la programación masiva. Inténtalo de nuevo.',
        ],

        'flash' => [
            'starter_blocked' => 'La programación masiva está disponible en Plus o superior. Actualiza para desbloquear.',
        ],
    ],

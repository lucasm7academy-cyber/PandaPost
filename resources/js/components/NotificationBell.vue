...
import { requests as inviteRequests } from '@/routes/app/invites';
...
if (channelName.value) {
    try {
        // TODO: Re-enable real-time notifications after Reverb/Pusher is properly configured
        ...
        //     }
        // });
        console.info('Real-time notifications temporarily disabled');
    } catch {
        // Gracefully handle Pusher/Echo initialization errors
...
const handleNotificationClick = (notification: Notification) => {
    ...
    if (notification.type === 'invite_received') {
        router.visit(inviteRequests.url());
        return;
    }

...
test('facebook publisher can publish reel', function () {
    Storage::fake();
    Storage::put('media/2026-01/reel.mp4', 'fake-video-binary-content');
...
test('facebook publisher fails reel publish with typed exception when media file missing', function () {
    Storage::fake();
    // Intentionally do NOT put the file — simulates unavailable media.
...
test('facebook publisher cleans up temp files after reel upload', function () {
    Storage::fake();
    Storage::put('media/2026-01/reel.mp4', 'fake-video');
